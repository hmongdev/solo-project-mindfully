...
select to_char(current_timestamp, 'Dy Mon d, yy - hh12:mi AM');
...
--Sun Dec 8, 12:00 AM
select * from history, to_char(history.date_created, 'Dy Mon d, yy - hh12:mi AM') as created where user_id = 1 order by history.date_created desc;


--PUT request
update "user" set "name" = 'asdf' where id = 1;

--DELETE request
delete from history where id = 13 and user_id = 1;
